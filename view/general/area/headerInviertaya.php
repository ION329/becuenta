<div class="hedheader bWhite">
    ...
    <div class="col-sm-2 col-xs- hH bWhite">
    	<div class="tabAll">
        	<div class="tabIn">
            	<img src="resources/img/important/be-logo.png" />
        	</div>
        </div>
    </div>
       ...
       <div class="tabAllMenHeader2 efeHov">
        	<div class="tabIn taR">
                ...
                <div class="dropdown menuNotif">
                    <button class="btn dropdown-toggle" type="button" style="position:relative;" id="dropMensajes" data-toggle="dropdown">
